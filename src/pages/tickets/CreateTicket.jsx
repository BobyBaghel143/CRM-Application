        ...
        <HomeLayout>
            <div className="min-h-[90vh] flex items-center justify-center" >
                <form
                    ...
                    className="min-w-[40rem] border p-20  border-sky-500 rounded-2xl hover:bg-sky-900 transition-all ease-in-out duration-300 ">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-green-700 text-lg font-semibold text-white px-4 py-2 rounded-md hover:bg-green-500 transition-all ease-in-out duration-300 "
                    >
                        Submit
                    </button>
                </form>
