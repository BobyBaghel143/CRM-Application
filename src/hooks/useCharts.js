...
ChartJS.register( ArcElement, Title, Tooltip, Legend, CategoryScale, LinearScale, PointElement, LineElement,  BarElement);
...
function useCharts() {
  ...
  const lineChartData = {
    ...
    if (ticketsState.ticketList.length > 0) {
        ...
        let openTicketsByMonth = { 'January': 0, 'February': 0, 'March': 0, 'April': 0, 'May': 0, 'June': 0, 'July': 0, 'August': 0, 'September': 0, 'Octover': 0, 'November': 0, 'December': 0 };
        let inProgressTicketsByMonth = { 'January': 0, 'February': 0, 'March': 0, 'April': 0, 'May': 0, 'June': 0, 'July': 0, 'August': 0, 'September': 0, 'Octover': 0, 'November': 0, 'December': 0 };
        let resolvedTicketsByMonth = { 'January': 0, 'February': 0, 'March': 0, 'April': 0, 'May': 0, 'June': 0, 'July': 0, 'August': 0, 'September': 0, 'Octover': 0, 'November': 0, 'December': 0 };
        ...
        for (let i = 0; i < 10; i++) {
            ...
            //  dateObject.toLocalDateString() ->  gives us string in the format  DD/MM/YYYY
        ...
        ticketsState.ticketList.forEach((ticket) => {
            ...
            const date = ticket.createdAt.split("T")[0]; // T -> time , date
