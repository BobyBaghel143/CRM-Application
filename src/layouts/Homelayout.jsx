            ...
            <li className="absolute bottom-8 w-3/4">
              <div className="w-full flex justify-center items-center ">
                {!authState.isLoggedIn ? (
                  ...
                  <>
                    <button onClick={onLogout} className="btn-primary text-center px-2 py-1 rounded-md  font-semibold w-full " > Logout </button>
                    <Link className="btn-secondary text-center px-2 py-1 rounded-md  font-semibold w-full "> Profile </Link>
                  </>
                )}
              </div>
            </li>
